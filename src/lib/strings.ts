...
export const S = {
  ...
  customFields: {
    ...
    empty: loc("Пока нет своих полей. Добавьте первое — оно появится в карточках выбранного типа.", "Hozircha o‘z maydonlari yo‘q."),
    entity: loc("Тип карточки", "Karta turi"),
    entityContact: loc("Контакт", "Kontakt"),
    entityLead: loc("Лид", "Lid"),
    entityDeal: loc("Сделка", "Bitim"),
