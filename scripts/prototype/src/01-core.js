...
const ICONS = {
  ...
  pencil: '<path d="M4 20h4L19.5 8.5a2.1 2.1 0 0 0-3-3L5 17v3Z"/><path d="M14.5 6.5 17.5 9.5"/>',
  trash: '<path d="M4 6.5h16"/><path d="M9.5 6.5V4.8A1.3 1.3 0 0 1 10.8 3.5h2.4a1.3 1.3 0 0 1 1.3 1.3v1.7"/><path d="M6.5 6.5 7.4 20a1.4 1.4 0 0 0 1.4 1.3h6.4a1.4 1.4 0 0 0 1.4-1.3l.9-13.5"/>',
  'arrow-up': '<path d="M12 19V5"/><path d="m6 11 6-6 6 6"/>',
  'arrow-down': '<path d="M12 5v14"/><path d="m6 13 6 6 6-6"/>',
  panel: '<rect x="3" y="4" width="18" height="16" rx="2.4"/><path d="M9.5 4v16"/>',
  pin: '<path d="M14.5 3.5 20.5 9.5"/><path d="M16.5 5.5 12 10l-4.5 1.5L5 14l5 5 2.5-2.5L14 12l4.5-4.5"/><path d="m5 19-2.5 2.5"/>',
};
